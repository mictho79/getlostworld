import { f as createComponent, j as renderComponent, r as renderTemplate, i as createAstro, k as Fragment, h as addAttribute, u as unescapeHTML, m as maybeRenderHead } from '../../chunks/astro/server_CpuTesIu.mjs';
import 'kleur/colors';
import { C as COUNTRY_DATA, a as COUNTRY_VIBES, s as slugify, b as COUNTRY_INSIGHTS, c as COUNTRY_CITIES, d as COUNTRY_PEAKS, e as COUNTRY_DISHES, $ as $$Base } from '../../chunks/countryData_BPFTW8lO.mjs';
import { T as TRAVEL_ADVISORY, a as TRAVEL_SCORES } from '../../chunks/travelScores_CMQt3Oxi.mjs';
/* empty css                                     */
...
const COUNTRY_EXTRAS = {
  ...
  'United Kingdom': { climate:'Oceanic / Temperate', religion:'Christianity (59%)', hdi:'high', dishes:['Fish & chips','Full English','Tikka masala'], athletes:['Mo Farah (athletics)','Andy Murray (tennis)'], landlocked:false },
...
const $$slug = createComponent(($$result, $$props, $$slots) => {
  ...
  function buildCountryFromLocal(name) {
    ...
    return {
      ...
      sport: local.sport || "\u2014",
      fact: local.fact || "",
      vibe: COUNTRY_VIBES[name] || "Fascinating \xB7 Historic \xB7 Unique",
      area: "\u2014",
      areaRaw: 0,
      ...
      insights: COUNTRY_INSIGHTS[name] || {},
      borderCountries: [],
      neighborSlugs: []
    };
  }
  ...
  const findCountry = (s) => {
    const name = Object.keys(COUNTRY_DATA).find((k) => slugify(k) === s);
    if (!name) return null;
  ...
  const labelA = countryA.subregion || regionA;
  const labelB = countryB.subregion || regionB;
  ...
  const SCORE_META = [
    { key: "tourism", label: "Tourism access", icon: "\u2708\uFE0F" },
    { key: "budget", label: "Budget travel", icon: "\u{1F4B0}" },
    { key: "nature", label: "Nature & outdoors", icon: "\u{1F3D4}" },
    { key: "food", label: "Food scene", icon: "\u{1F37D}" },
    { key: "culture", label: "Cultural depth", icon: "\u{1F3DB}" },
    { key: "langEase", label: "Language ease", icon: "\u{1F4AC}" }
  ];
  const SCORE_LABELS = {
    tourism: "smooth, well-connected tourism",
    budget: "affordable high-value travel",
    nature: "wild landscapes & outdoor adventure",
    food: "exceptional food culture",
    culture: "deep historical immersion",
    langEase: "ease of communication"
  };
  ...
  function buildEditorial(a, b) {
    ...
    if (a.region !== b.region)
      parts.push(`${a.name} and ${b.name} occupy opposite corners of the world \u2014 ${a.region} and ${b.region} \u2014 making this a comparison of two fundamentally different ways to travel.`);
    else if (a.subregion && b.subregion && a.subregion !== b.subregion)
      parts.push(`Both sit within ${a.region}, yet ${a.name} (${a.subregion}) and ${b.name} (${b.subregion}) represent distinct chapters of what the region has to offer.`);
    else
      parts.push(`${a.name} and ${b.name} are near neighbours in ${a.region}, but each has shaped a character all its own.`);
    parts.push(`${a.name} \u2014 ${vA[0]}, ${(vA[1] || "").toLowerCase()} \u2014 excels in ${SCORE_LABELS[topA]}.`);
    parts.push(`${b.name} \u2014 ${vB[0]}, ${(vB[1] || "").toLowerCase()} \u2014 is the stronger pick for ${SCORE_LABELS[topB]}.`);
    if (a.sport !== "\u2014" && b.sport !== "\u2014" && a.sport !== b.sport)
      parts.push(`Sports tell the story: ${a.name} lives and breathes ${a.sport}, while ${b.name} rallies around ${b.sport}.`);
    if (a.dish && b.dish && a.dish !== b.dish)
      parts.push(`At the table, order ${a.dish} in ${a.name} and ${b.dish} in ${b.name} \u2014 two plates, two worlds.`);
    return parts.join(" ");
  }
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": title, "description": description, "data-astro-cid-bdsczzry": true }, { "default": ($$result2) => renderTemplate(_a || (_a = __template(['   <script type="application/json" id="cmp-countries">', "<\/script> ", '<div class="pg"', ' data-astro-cid-bdsczzry> <!-- \u2500\u2500 Decorative background \u2500\u2500 --> <div class="pg-deco" aria-hidden="true" data-astro-cid-bdsczzry> <div class="pg-ring pg-ring-1" data-astro-cid-bdsczzry></div> <div class="pg-ring pg-ring-2" data-astro-cid-bdsczzry></div> <div class="pg-ring pg-ring-3" data-astro-cid-bdsczzry></div> </div> <div class="pg-wrap" data-astro-cid-bdsczzry> <!-- 1 \u2500\u2500 Breadcrumb \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <nav class="breadcrumb" aria-label="Breadcrumb" data-astro-cid-bdsczzry> <a href="/" data-astro-cid-bdsczzry>Home</a><span aria-hidden="true" data-astro-cid-bdsczzry>\u203A</span> <span data-astro-cid-bdsczzry>Compare</span><span aria-hidden="true" data-astro-cid-bdsczzry>\u203A</span> <span data-astro-cid-bdsczzry>', " vs ", "</span> </nav> <!-- \u2500\u2500 Advisory banners \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> ", ' <!-- 2 \u2500\u2500 Hero \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <header class="hero" data-astro-cid-bdsczzry> <div class="hero-globe hero-globe--a" aria-hidden="true" data-astro-cid-bdsczzry></div> <div class="hero-globe hero-globe--b" aria-hidden="true" data-astro-cid-bdsczzry></div> <div class="hero-side hero-side--a" data-astro-cid-bdsczzry> <div class="hero-code" aria-hidden="true" data-astro-cid-bdsczzry>', '</div> <span class="hero-flag" data-astro-cid-bdsczzry>', '</span> <h1 class="hero-name hero-name--a" data-astro-cid-bdsczzry>', '</h1> <p class="hero-vibe" data-astro-cid-bdsczzry>', '</p> <span class="hero-tag"', " data-astro-cid-bdsczzry>", '</span> </div> <div class="hero-vs" aria-hidden="true" data-astro-cid-bdsczzry> <span class="hero-vs-text" data-astro-cid-bdsczzry>VS</span> </div> <div class="hero-side hero-side--b" data-astro-cid-bdsczzry> <div class="hero-code" aria-hidden="true" data-astro-cid-bdsczzry>', '</div> <span class="hero-flag" data-astro-cid-bdsczzry>', '</span> <h1 class="hero-name hero-name--b" data-astro-cid-bdsczzry>', '</h1> <p class="hero-vibe" data-astro-cid-bdsczzry>', '</p> <span class="hero-tag"', " data-astro-cid-bdsczzry>", '</span> </div> </header> <!-- 3 \u2500\u2500 Country switcher \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <div class="switcher" role="search" aria-label="Switch countries" data-astro-cid-bdsczzry> <div class="sw-field" data-astro-cid-bdsczzry> <label class="sw-label" for="sw-a" data-astro-cid-bdsczzry>Country A</label> <div class="sw-wrap" data-astro-cid-bdsczzry> <input id="sw-a" type="text" class="sw-input" autocomplete="off" spellcheck="false" data-astro-cid-bdsczzry> <div class="sw-drop" id="sw-drop-a" role="listbox" hidden data-astro-cid-bdsczzry></div> </div> </div> <button class="sw-swap" id="sw-swap" title="Swap" aria-label="Swap countries" data-astro-cid-bdsczzry> <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-bdsczzry> <path d="M7 16V4m0 0L3 8m4-4l4 4" data-astro-cid-bdsczzry></path><path d="M17 8v12m0 0l4-4m-4 4l-4-4" data-astro-cid-bdsczzry></path> </svg> </button> <div class="sw-field" data-astro-cid-bdsczzry> <label class="sw-label" for="sw-b" data-astro-cid-bdsczzry>Country B</label> <div class="sw-wrap" data-astro-cid-bdsczzry> <input id="sw-b" type="text" class="sw-input" autocomplete="off" spellcheck="false" data-astro-cid-bdsczzry> <div class="sw-drop" id="sw-drop-b" role="listbox" hidden data-astro-cid-bdsczzry></div> </div> </div> </div> <!-- 4 \u2500\u2500 Key facts \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <section class="section" data-astro-cid-bdsczzry> <h2 class="sh" data-astro-cid-bdsczzry>Key facts</h2> <div class="facts" data-astro-cid-bdsczzry> <div class="facts-head" data-astro-cid-bdsczzry> <span class="facts-a"', " data-astro-cid-bdsczzry>", " ", '</span> <span class="facts-m" data-astro-cid-bdsczzry></span> <span class="facts-b"', " data-astro-cid-bdsczzry>", " ", "</span> </div> ", " ", " ", " ", " ", " ", " ", " ", ' </div> </section> <!-- 5 \u2500\u2500 Travel Index \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <section class="section" data-astro-cid-bdsczzry> <h2 class="sh" data-astro-cid-bdsczzry>Travel Index</h2> <div class="ti" data-astro-cid-bdsczzry> <!-- Header row --> <div class="ti-head" data-astro-cid-bdsczzry> <span data-astro-cid-bdsczzry></span> <span class="ti-country-label"', " data-astro-cid-bdsczzry>", " ", '</span> <span class="ti-country-label"', " data-astro-cid-bdsczzry>", " ", "</span> </div> <!-- Score rows \u2014 computed in frontmatter to avoid TS cast issues in JSX --> ", ' </div> <!-- Best for verdict cards --> <div class="ti-verdicts" data-astro-cid-bdsczzry> <div class="ti-verdict"', ' data-astro-cid-bdsczzry> <span class="ti-verdict-flag" data-astro-cid-bdsczzry>', '</span> <div data-astro-cid-bdsczzry> <p class="ti-verdict-kicker" data-astro-cid-bdsczzry>Best for</p> <p class="ti-verdict-value" data-astro-cid-bdsczzry>', '</p> </div> </div> <div class="ti-verdict"', ' data-astro-cid-bdsczzry> <span class="ti-verdict-flag" data-astro-cid-bdsczzry>', '</span> <div data-astro-cid-bdsczzry> <p class="ti-verdict-kicker" data-astro-cid-bdsczzry>Best for</p> <p class="ti-verdict-value" data-astro-cid-bdsczzry>', '</p> </div> </div> </div> </section> <!-- 6 \u2500\u2500 Geography & Nature \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <section class="section" data-astro-cid-bdsczzry> <h2 class="sh" data-astro-cid-bdsczzry>\u26F0 Geography &amp; Nature</h2> <div class="duo" data-astro-cid-bdsczzry> <div class="duo-card" data-astro-cid-bdsczzry> <div class="duo-head"', " data-astro-cid-bdsczzry>", " ", '</div> <div class="dr-list" data-astro-cid-bdsczzry> ', " ", " ", ' <div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Coastline</span><span class="dr-v" data-astro-cid-bdsczzry>', '</span></div> </div> </div> <div class="duo-card" data-astro-cid-bdsczzry> <div class="duo-head"', " data-astro-cid-bdsczzry>", " ", '</div> <div class="dr-list" data-astro-cid-bdsczzry> ', " ", " ", ' <div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Coastline</span><span class="dr-v" data-astro-cid-bdsczzry>', '</span></div> </div> </div> </div> </section> <!-- 7 \u2500\u2500 People & Culture \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <section class="section" data-astro-cid-bdsczzry> <h2 class="sh" data-astro-cid-bdsczzry>\u{1F465} People &amp; Culture</h2> <div class="duo" data-astro-cid-bdsczzry> <div class="duo-card" data-astro-cid-bdsczzry> <div class="duo-head"', " data-astro-cid-bdsczzry>", " ", '</div> <div class="dr-list" data-astro-cid-bdsczzry> ', " ", " ", " ", " ", ' </div> </div> <div class="duo-card" data-astro-cid-bdsczzry> <div class="duo-head"', " data-astro-cid-bdsczzry>", " ", '</div> <div class="dr-list" data-astro-cid-bdsczzry> ', " ", " ", " ", " ", ' </div> </div> </div> </section> <!-- 8 \u2500\u2500 Food & Cuisine \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <section class="section" data-astro-cid-bdsczzry> <h2 class="sh" data-astro-cid-bdsczzry>\u{1F37D} Food &amp; Cuisine</h2> <div class="duo" data-astro-cid-bdsczzry> <div class="duo-card" data-astro-cid-bdsczzry> <div class="duo-head"', " data-astro-cid-bdsczzry>", " ", '</div> <div class="dr-list" data-astro-cid-bdsczzry> ', " ", ' </div> </div> <div class="duo-card" data-astro-cid-bdsczzry> <div class="duo-head"', " data-astro-cid-bdsczzry>", " ", '</div> <div class="dr-list" data-astro-cid-bdsczzry> ', " ", ' </div> </div> </div> </section> <!-- 9 \u2500\u2500 Sport \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <section class="section" data-astro-cid-bdsczzry> <h2 class="sh" data-astro-cid-bdsczzry>\u{1F3C5} Sport</h2> <div class="duo" data-astro-cid-bdsczzry> <div class="duo-card" data-astro-cid-bdsczzry> <div class="duo-head"', " data-astro-cid-bdsczzry>", " ", '</div> <div class="dr-list" data-astro-cid-bdsczzry> ', " ", ' </div> </div> <div class="duo-card" data-astro-cid-bdsczzry> <div class="duo-head"', " data-astro-cid-bdsczzry>", " ", '</div> <div class="dr-list" data-astro-cid-bdsczzry> ', " ", ' </div> </div> </div> </section> <!-- 10 \u2500\u2500 Which should you visit? \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <section class="section" data-astro-cid-bdsczzry> ', ' </section> <!-- 11 \u2500\u2500 Explore each country \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> <section class="section" data-astro-cid-bdsczzry> <h2 class="sh" data-astro-cid-bdsczzry>Country profiles</h2> <div class="cta-row" data-astro-cid-bdsczzry> ', " ", " </div> </section> <!-- 12 \u2500\u2500 More comparisons \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> ", " <!-- 13 \u2500\u2500 Neighbouring countries \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 --> ", ' <!-- World map CTA --> <div class="map-cta" data-astro-cid-bdsczzry> <a href="/" class="map-btn" data-astro-cid-bdsczzry> <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-bdsczzry> <circle cx="12" cy="12" r="10" data-astro-cid-bdsczzry></circle><line x1="2" y1="12" x2="22" y2="12" data-astro-cid-bdsczzry></line> <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" data-astro-cid-bdsczzry></path> </svg>\nBack to world map\n</a> </div> </div> </div>'])), unescapeHTML(JSON.stringify(countriesList)), maybeRenderHead(), addAttribute(`--ca:${accentA};--cb:${accentB};`, "style"), countryA.name, countryB.name, hasReconsider && renderTemplate`<div class="advisory advisory--reconsider" role="alert" data-astro-cid-bdsczzry> <span class="advisory-icon" data-astro-cid-bdsczzry>⚠️</span> <span data-astro-cid-bdsczzry>Travel to <strong data-astro-cid-bdsczzry>${reconsiderNames.join(" and ")}</strong> requires serious caution. Check current government travel advisories before planning any trip.</span> </div>`, countryA.cca2, countryA.flag, countryA.name, countryA.vibe, addAttribute(`--t:${accentA};`, "style"), labelA, countryB.cca2, countryB.flag, countryB.name, countryB.vibe, addAttribute(`--t:${accentB};`, "style"), labelB, addAttribute(`color:${accentA};`, "style"), countryA.flag, countryA.name, addAttribute(`color:${accentB};`, "style"), countryB.flag, countryB.name, countryA.capital !== "\u2014" || countryB.capital !== "\u2014" ? renderTemplate`<div class="facts-row" data-astro-cid-bdsczzry> <span class="facts-a" data-astro-cid-bdsczzry>${countryA.capital}</span> <span class="facts-m" data-astro-cid-bdsczzry>Capital</span> <span class="facts-b" data-astro-cid-bdsczzry>${countryB.capital}</span> </div>` : null, countryA.population !== "\u2014" || countryB.population !== "\u2014" ? renderTemplate`<div class="facts-row" data-astro-cid-bdsczzry> <span${addAttribute(`facts-a${countryA.populationRaw >= countryB.populationRaw && countryA.populationRaw > 0 ? " facts-win" : ""}`, "class")} data-astro-cid-bdsczzry>${countryA.population}</span> <span class="facts-m" data-astro-cid-bdsczzry>Population</span> <span${addAttribute(`facts-b${countryB.populationRaw > countryA.populationRaw ? " facts-win" : ""}`, "class")} data-astro-cid-bdsczzry>${countryB.population}</span> </div>` : null, countryA.area !== "\u2014" || countryB.area !== "\u2014" ? renderTemplate`<div class="facts-row" data-astro-cid-bdsczzry> <span${addAttribute(`facts-a${countryA.areaRaw >= countryB.areaRaw && countryA.areaRaw > 0 ? " facts-win" : ""}`, "class")} data-astro-cid-bdsczzry>${countryA.area !== "\u2014" ? `${countryA.area} km\xB2` : "\u2014"}</span> <span class="facts-m" data-astro-cid-bdsczzry>Area</span> <span${addAttribute(`facts-b${countryB.areaRaw > countryA.areaRaw ? " facts-win" : ""}`, "class")} data-astro-cid-bdsczzry>${countryB.area !== "\u2014" ? `${countryB.area} km\xB2` : "\u2014"}</span> </div>` : null, countryA.language !== "\u2014" || countryB.language !== "\u2014" ? renderTemplate`<div class="facts-row" data-astro-cid-bdsczzry> <span class="facts-a" data-astro-cid-bdsczzry>${countryA.language}</span> <span class="facts-m" data-astro-cid-bdsczzry>Language</span> <span class="facts-b" data-astro-cid-bdsczzry>${countryB.language}</span> </div>` : null, countryA.currency !== "\u2014" || countryB.currency !== "\u2014" ? renderTemplate`<div class="facts-row" data-astro-cid-bdsczzry> <span class="facts-a" data-astro-cid-bdsczzry>${countryA.currency}</span> <span class="facts-m" data-astro-cid-bdsczzry>Currency</span> <span class="facts-b" data-astro-cid-bdsczzry>${countryB.currency}</span> </div>` : null, countryA.sport !== "\u2014" || countryB.sport !== "\u2014" ? renderTemplate`<div class="facts-row" data-astro-cid-bdsczzry> <span class="facts-a" data-astro-cid-bdsczzry>${countryA.sport}</span> <span class="facts-m" data-astro-cid-bdsczzry>National sport</span> <span class="facts-b" data-astro-cid-bdsczzry>${countryB.sport}</span> </div>` : null, countryA.dish || countryB.dish ? renderTemplate`<div class="facts-row" data-astro-cid-bdsczzry> <span class="facts-a" data-astro-cid-bdsczzry>${countryA.dish || "\u2014"}</span> <span class="facts-m" data-astro-cid-bdsczzry>National dish</span> <span class="facts-b" data-astro-cid-bdsczzry>${countryB.dish || "\u2014"}</span> </div>` : null, countryA.peak || countryB.peak ? renderTemplate`<div class="facts-row" data-astro-cid-bdsczzry> <span${addAttribute(`facts-a${countryA.peak && countryB.peak && countryA.peak.elevation >= countryB.peak.elevation ? " facts-win" : ""}`, "class")} data-astro-cid-bdsczzry> ${countryA.peak ? `${countryA.peak.name} \xB7 ${countryA.peak.elevation.toLocaleString("en-US")} m` : "\u2014"} </span> <span class="facts-m" data-astro-cid-bdsczzry>Highest peak</span> <span${addAttribute(`facts-b${countryA.peak && countryB.peak && countryB.peak.elevation > countryA.peak.elevation ? " facts-win" : ""}`, "class")} data-astro-cid-bdsczzry> ${countryB.peak ? `${countryB.peak.name} \xB7 ${countryB.peak.elevation.toLocaleString("en-US")} m` : "\u2014"} </span> </div>` : null, addAttribute(`color:${accentA};`, "style"), countryA.flag, countryA.name, addAttribute(`color:${accentB};`, "style"), countryB.flag, countryB.name, travelRows.map((row) => renderTemplate`<div class="ti-row" data-astro-cid-bdsczzry> <span class="ti-label" data-astro-cid-bdsczzry>${row.icon} ${row.label}</span> <div class="ti-bar-wrap" data-astro-cid-bdsczzry> <div class="ti-bar"${addAttribute(`--pct:${row.sA / 5 * 100}%;--col:${accentA};`, "style")} data-astro-cid-bdsczzry></div> <span${addAttribute(row.sA > row.sB ? "ti-score ti-score--win" : "ti-score", "class")}${addAttribute(row.sA > row.sB ? `color:${accentA};` : "", "style")} data-astro-cid-bdsczzry>${row.sA}/5</span> </div> <div class="ti-bar-wrap" data-astro-cid-bdsczzry> <div class="ti-bar"${addAttribute(`--pct:${row.sB / 5 * 100}%;--col:${accentB};`, "style")} data-astro-cid-bdsczzry></div> <span${addAttribute(row.sB > row.sA ? "ti-score ti-score--win" : "ti-score", "class")}${addAttribute(row.sB > row.sA ? `color:${accentB};` : "", "style")} data-astro-cid-bdsczzry>${row.sB}/5</span> </div> </div>`), addAttribute(`--vc:${accentA};`, "style"), countryA.flag, top2A.join(" & "), addAttribute(`--vc:${accentB};`, "style"), countryB.flag, top2B.join(" & "), addAttribute(`--dh:${accentA};`, "style"), countryA.flag, countryA.name, countryA.area !== "\u2014" && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Area</span><span class="dr-v" data-astro-cid-bdsczzry>${countryA.area} km²</span></div>`, exA.climate && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Climate</span><span class="dr-v" data-astro-cid-bdsczzry>${exA.climate}</span></div>`, countryA.peak && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Highest peak</span><span class="dr-v" data-astro-cid-bdsczzry>${countryA.peak.name} · ${countryA.peak.elevation.toLocaleString("en-US")} m</span></div>`, exA.landlocked ? "Landlocked" : "Coastal", addAttribute(`--dh:${accentB};`, "style"), countryB.flag, countryB.name, countryB.area !== "\u2014" && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Area</span><span class="dr-v" data-astro-cid-bdsczzry>${countryB.area} km²</span></div>`, exB.climate && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Climate</span><span class="dr-v" data-astro-cid-bdsczzry>${exB.climate}</span></div>`, countryB.peak && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Highest peak</span><span class="dr-v" data-astro-cid-bdsczzry>${countryB.peak.name} · ${countryB.peak.elevation.toLocaleString("en-US")} m</span></div>`, exB.landlocked ? "Landlocked" : "Coastal", addAttribute(`--dh:${accentA};`, "style"), countryA.flag, countryA.name, countryA.population !== "\u2014" && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Population</span><span class="dr-v" data-astro-cid-bdsczzry>${countryA.population}</span></div>`, countryA.populationRaw && countryA.areaRaw ? renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Density</span><span class="dr-v" data-astro-cid-bdsczzry>${density(countryA.populationRaw, countryA.areaRaw)}</span></div>` : null, countryA.language !== "\u2014" && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Language${countryA.language.includes(",") ? "s" : ""}</span><span class="dr-v" data-astro-cid-bdsczzry>${countryA.language}</span></div>`, exA.religion && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Religion</span><span class="dr-v" data-astro-cid-bdsczzry>${exA.religion}</span></div>`, exA.hdi && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>HDI tier</span><span${addAttribute(`dr-v dr-hdi dr-hdi--${exA.hdi}`, "class")} data-astro-cid-bdsczzry>${exA.hdi.charAt(0).toUpperCase() + exA.hdi.slice(1)}</span></div>`, addAttribute(`--dh:${accentB};`, "style"), countryB.flag, countryB.name, countryB.population !== "\u2014" && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Population</span><span class="dr-v" data-astro-cid-bdsczzry>${countryB.population}</span></div>`, countryB.populationRaw && countryB.areaRaw ? renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Density</span><span class="dr-v" data-astro-cid-bdsczzry>${density(countryB.populationRaw, countryB.areaRaw)}</span></div>` : null, countryB.language !== "\u2014" && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Language${countryB.language.includes(",") ? "s" : ""}</span><span class="dr-v" data-astro-cid-bdsczzry>${countryB.language}</span></div>`, exB.religion && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>Religion</span><span class="dr-v" data-astro-cid-bdsczzry>${exB.religion}</span></div>`, exB.hdi && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>HDI tier</span><span${addAttribute(`dr-v dr-hdi dr-hdi--${exB.hdi}`, "class")} data-astro-cid-bdsczzry>${exB.hdi.charAt(0).toUpperCase() + exB.hdi.slice(1)}</span></div>`, addAttribute(`--dh:${accentA};`, "style"), countryA.flag, countryA.name, countryA.dish && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>National dish</span><span class="dr-v" data-astro-cid-bdsczzry>${countryA.dish}</span></div>`, exA.dishes?.length > 0 && renderTemplate`<div class="dr dr--wrap" data-astro-cid-bdsczzry> <span class="dr-l" data-astro-cid-bdsczzry>Also known for</span> <span class="dr-v dr-pills" data-astro-cid-bdsczzry> ${exA.dishes.map((d) => renderTemplate`<span class="pill-sm" data-astro-cid-bdsczzry>${d}</span>`)} </span> </div>`, addAttribute(`--dh:${accentB};`, "style"), countryB.flag, countryB.name, countryB.dish && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>National dish</span><span class="dr-v" data-astro-cid-bdsczzry>${countryB.dish}</span></div>`, exB.dishes?.length > 0 && renderTemplate`<div class="dr dr--wrap" data-astro-cid-bdsczzry> <span class="dr-l" data-astro-cid-bdsczzry>Also known for</span> <span class="dr-v dr-pills" data-astro-cid-bdsczzry> ${exB.dishes.map((d) => renderTemplate`<span class="pill-sm" data-astro-cid-bdsczzry>${d}</span>`)} </span> </div>`, addAttribute(`--dh:${accentA};`, "style"), countryA.flag, countryA.name, countryA.sport !== "\u2014" && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>National sport</span><span class="dr-v" data-astro-cid-bdsczzry>${countryA.sport}</span></div>`, exA.athletes?.length > 0 && exA.athletes.map((a) => renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l dr-l--ath" data-astro-cid-bdsczzry>★</span><span class="dr-v" data-astro-cid-bdsczzry>${a}</span></div>`), addAttribute(`--dh:${accentB};`, "style"), countryB.flag, countryB.name, countryB.sport !== "\u2014" && renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l" data-astro-cid-bdsczzry>National sport</span><span class="dr-v" data-astro-cid-bdsczzry>${countryB.sport}</span></div>`, exB.athletes?.length > 0 && exB.athletes.map((a) => renderTemplate`<div class="dr" data-astro-cid-bdsczzry><span class="dr-l dr-l--ath" data-astro-cid-bdsczzry>★</span><span class="dr-v" data-astro-cid-bdsczzry>${a}</span></div>`), dntA || dntB ? renderTemplate`<div class="advisory-info-block" data-astro-cid-bdsczzry> ${dntA && renderTemplate`<p class="advisory-info-msg" data-astro-cid-bdsczzry> <strong data-astro-cid-bdsczzry>⛔ ${countryA.name}:</strong> Travel is not recommended at this time. This page is provided for informational purposes only.
</p>`} ${dntB && renderTemplate`<p class="advisory-info-msg" data-astro-cid-bdsczzry> <strong data-astro-cid-bdsczzry>⛔ ${countryB.name}:</strong> Travel is not recommended at this time. This page is provided for informational purposes only.
</p>`} ${(!dntA || !dntB) && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-bdsczzry": true }, { "default": ($$result3) => renderTemplate` <h2 class="sh" data-astro-cid-bdsczzry>${dntA ? countryB.name : countryA.name} — Key context</h2> <blockquote class="editorial" data-astro-cid-bdsczzry>${editorial}</blockquote> ` })}`} </div>` : renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "data-astro-cid-bdsczzry": true }, { "default": ($$result3) => renderTemplate` <h2 class="sh" data-astro-cid-bdsczzry>Which should you visit?</h2> <blockquote class="editorial" data-astro-cid-bdsczzry>${editorial}</blockquote> ` })}`, dntA ? renderTemplate`<div class="cta-card cta-card--dnt"${addAttribute(`--cc:${accentA};`, "style")} data-astro-cid-bdsczzry> <span class="cta-flag" data-astro-cid-bdsczzry>${countryA.flag}</span> <span class="cta-name" data-astro-cid-bdsczzry>${countryA.name}</span> <span class="cta-sub cta-sub--dnt" data-astro-cid-bdsczzry>Informational only — travel not advised</span> </div>` : renderTemplate`<a${addAttribute(`/country/${countryA.slug}/`, "href")} class="cta-card"${addAttribute(`--cc:${accentA};`, "style")} data-astro-cid-bdsczzry> <span class="cta-flag" data-astro-cid-bdsczzry>${countryA.flag}</span> <span class="cta-name" data-astro-cid-bdsczzry>${countryA.name}</span> <span class="cta-sub" data-astro-cid-bdsczzry>${labelA}</span> <span class="cta-arr" data-astro-cid-bdsczzry>→</span> </a>`, dntB ? renderTemplate`<div class="cta-card cta-card--dnt"${addAttribute(`--cc:${accentB};`, "style")} data-astro-cid-bdsczzry> <span class="cta-flag" data-astro-cid-bdsczzry>${countryB.flag}</span> <span class="cta-name" data-astro-cid-bdsczzry>${countryB.name}</span> <span class="cta-sub cta-sub--dnt" data-astro-cid-bdsczzry>Informational only — travel not advised</span> </div>` : renderTemplate`<a${addAttribute(`/country/${countryB.slug}/`, "href")} class="cta-card"${addAttribute(`--cc:${accentB};`, "style")} data-astro-cid-bdsczzry> <span class="cta-flag" data-astro-cid-bdsczzry>${countryB.flag}</span> <span class="cta-name" data-astro-cid-bdsczzry>${countryB.name}</span> <span class="cta-sub" data-astro-cid-bdsczzry>${labelB}</span> <span class="cta-arr" data-astro-cid-bdsczzry>→</span> </a>`, moreSlice.length > 0 && renderTemplate`<section class="section" data-astro-cid-bdsczzry> <h2 class="sh" data-astro-cid-bdsczzry>More comparisons</h2> <div class="pills" data-astro-cid-bdsczzry> ${moreSlice.map((m) => renderTemplate`<a${addAttribute(m.href, "href")} class="pill" data-astro-cid-bdsczzry>${m.label}</a>`)} </div> </section>`, (countryA.borderCountries.length > 0 || countryB.borderCountries.length > 0) && renderTemplate`<section class="section neighbours-section" data-astro-cid-bdsczzry> ${countryA.borderCountries.length > 0 && renderTemplate`<div data-astro-cid-bdsczzry> <h2 class="sh sh--inline" data-astro-cid-bdsczzry>${countryA.flag} ${countryA.name} borders</h2> <div class="pills" data-astro-cid-bdsczzry> ${countryA.borderCountries.map((b) => renderTemplate`<a${addAttribute(`/country/${b.slug}/`, "href")} class="pill pill--sm" data-astro-cid-bdsczzry>${b.name}</a>`)} </div> </div>`} ${countryB.borderCountries.length > 0 && renderTemplate`<div data-astro-cid-bdsczzry> <h2 class="sh sh--inline" data-astro-cid-bdsczzry>${countryB.flag} ${countryB.name} borders</h2> <div class="pills" data-astro-cid-bdsczzry> ${countryB.borderCountries.map((b) => renderTemplate`<a${addAttribute(`/country/${b.slug}/`, "href")} class="pill pill--sm" data-astro-cid-bdsczzry>${b.name}</a>`)} </div> </div>`} </section>`), "head": ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": ($$result3) => renderTemplate(_b || (_b = __template([' <script type="application/ld+json">', '<\/script> <meta property="og:title"', '> <meta property="og:description"', '> <meta property="og:url"', '> <meta property="og:type" content="website"> '])), unescapeHTML(jsonLd), addAttribute(title, "content"), addAttribute(description, "content"), addAttribute(pageUrl, "content")) })}` })}   `;
